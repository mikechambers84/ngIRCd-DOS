...
cb_connserver(int sock, UNUSED short what)
{
        ...
        //TODO: fix this, do i even need to do anything?
...
int bind(int sockfd, unsigned int port);
...
New_Connection(int Sock, UNUSED bool IsSSL)
{
        ...
        new_sock_len = 4; //(int)sizeof(new_addr);
#ifdef XCHOP
...
New_Server( int Server , ng_ipaddr_t *dest)
{
        ...
        new_sock = 0; //TODO: socket(af_dest, SOCK_STREAM, 0);
