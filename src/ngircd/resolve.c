...
//TODO:
        ...
        *resbuf = 0;
        ...
        //TODO: h = gethostbyaddr((char *)&Addr->sin_addr, sizeof(Addr->sin_addr), AF_INET);
        if (h) {
...
#endif
{
        ...
        return a == NULL;
#else
        /*struct hostent *h = gethostbyname(hostname); //TODO
        ...
        //TODO: memcpy(&addr.sin4.sin_addr, h->h_addr, sizeof(struct in_addr));
